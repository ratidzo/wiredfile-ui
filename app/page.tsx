    ...
    <div className="flex justify-center">
      <section className="flex flex-col items-center w-full pt-[5.44rem]">
        <div>
          ...
          <h1 className="text-5xl font-extrabold text-indigo-500 py-2">Wired to the Cloud.</h1>
        </div>
        <p className="mt-[1.31rem] text-2xl w-[48vw]">
            Manage all data from one place. <span className="text-indigo-500 font-bold">Wired File</span> makes it easy
